...
**▶ [もしもの防災会議を開く](https://bousai-meeting.tagmasa.jp/)**
...
- 🛡️ **MIMEタイプスニッフィング防止**（X-Content-Type-Options: nosniff）
- 🔒 **リファラ漏洩防止**（Referrer-Policy: strict-origin-when-cross-origin）
...
- 🔗 **公式CDN利用**：CesiumJS は公式CDN（cesium.com）から読み込み
